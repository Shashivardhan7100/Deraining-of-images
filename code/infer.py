...
#ckpt_path = r'D:\SEM6\CS354N\project\New\1.De-Raining_of_Images-main\OurModel\ckpt'
ckpt_path = r'D:\SEM6\CS354N\project\modified_new\1.De-Raining_of_Images-main\OurModel\ckpt'
...
def main():
    ...
    if len(args['snapshot']) > 0:
        ...
        print(os.path.join(ckpt_path, exp_name, args['snapshot'] + '.pth'))
